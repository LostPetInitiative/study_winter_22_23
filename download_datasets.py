...
if __name__ == "__main__":
    ...
    if not os.path.exists("./datasets/All3img_ExtraIG_train"):
        url = "https://zenodo.org/record/7606128/files/All3img_ExtraIG_train.zip"
        download_and_extract_archive(url, download_root=str("./datasets"), remove_finished=True, filename=f'train_set.zip')
    else:
    ...
    if not os.path.exists("./datasets/All3img_ExtraIG_val"):
        url = 'https://zenodo.org/record/7606128/files/All3img_ExtraIG_val.zip'
        download_and_extract_archive(url, download_root=str("./datasets"), remove_finished=True, filename=f'val_set.zip')
    else:
    ...
    if not os.path.exists("./datasets/Test"):
        ...
        download_and_extract_archive(url, download_root=str("./datasets"), remove_finished=True, filename=f'test.zip')
        shutil.move("./dataset/test_alignment/Test", "./dataset/Test")
        shutil.move("./dataset/test_alignment/cat_dog_class_csv", "./dataset/cat_dog_class_csv")
    else:
    ...
    if not os.path.exists("./yolov7_bbox_landmarks/pet_face_detection_dataset_1"):
        ...
        download_and_extract_archive(url, download_root=str("./yolov7_bbox_landmarks/"), remove_finished=True, filename=f'pet_face_detection_dataset_1.zip')
    else:
    ...
    if not os.path.exists("./yolov7_bbox/data/pet_face_detection_dataset_2.zip"):
        ...
        download_and_extract_archive(url, download_root=str("./yolov7_bbox/data/"), remove_finished=True, filename=f'pet_face_detection_dataset_2.zip')
    else:
